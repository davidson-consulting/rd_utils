...
namespace rd_utils::utils {
    ...
    namespace config {
		...
		struct config_error : utils::Rd_UtilsError {
...
std::ostream& operator<< (std::ostream& stream, const rd_utils::utils::config::array&);
std::ostream& operator<< (std::ostream& stream, const rd_utils::utils::config::dict&);
